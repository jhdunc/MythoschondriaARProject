...
namespace Broccoli.BroccoEditor
{
	...
	public class SproutLabEditor {
		...
		public void GenerateNewStructure () {
			...
			if (currentImplementation != null) currentImplementation.OnAfterGenerateNewStructure ();
		}
		/// <summary>
		...
		public void RegenerateStructure (int viewMode = VIEW_COMPOSITE) {
			...
			if (currentImplementation != null) currentImplementation.OnAfterRegenerateStructure ();
		}
		/// <summary>
