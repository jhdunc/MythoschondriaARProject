...

{
    ...
    private SeedInfo seedInfo; // be able to set as specific instance of script on an object
    ...
    public void UpdateList() // method to update the list of game objects in the world
    {
        ...
        {
            if (seedObj.GetComponent<SeedInfo>().itemID == seedInfo.itemID) // if the found object's itemID is the same as this object's itemID, then:
            {
